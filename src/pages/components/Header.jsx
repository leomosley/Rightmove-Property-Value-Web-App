...
function Header() {
    ...
    return (
        <div id="header">
            <a className="logo" href="https://www.rightmove.co.uk/">
                ...
                <li className="hamburger-container">
                    ...
                    <div className={`menuNav ${navbarOpen ? " showMenu" : ""}`}>
                        ...
                        <ul className="menu-list"><div class="bg"></div>
                            ...
                            <br></br>
                			<li>
                                <Link className="menu-nav-link" to="/loaded">Loaded Data</Link>
                            </li>
                            <br></br>
                			<li>
